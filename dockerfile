...
#
# CentOS-7, Apache 2.4, PHP 7.1, MYSQL, NodeJS
# 
# =============================================================================
FROM centos:centos7
...
COPY .env* /var/www/app/simplephpapp/
...
unzip v4.2.11.zip \
mkdir simplephpapp \
mv laravel-4.2.11/ /var/www/html/simplephpapp


# Instal app  
RUN git clone https://github.com/Saritasa/simplephpapp.git /var/www/app/simplephpapp/ 
RUN /var/www/app/simplephpapp 
